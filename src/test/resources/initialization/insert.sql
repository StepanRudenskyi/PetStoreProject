...
-- fill product_category table with data
INSERT INTO product_category (category_name, sale_limitation, storage_conditions)
VALUES ('Fruits & Veggies', 'None', 'Cool, dry place'),
       ('Meat & Fish', 'Use by date', 'Refrigerated or frozen'),
       ('Dairy & Eggs', 'Use by date', 'Refrigerated'),
       ('Bakery', 'Best before date', 'Cool, dry place'),
       ('Pantry Staples', 'None', 'Cool, dry place'),
       ('Sweets & Snacks', 'Best before date', 'Cool, dry place'),
       ('Beverages', 'None', 'Cool, dry place'),
       ('Organic & Dietary Products', 'Best before date', 'Cool, dry place'),
       ('Health & Beauty', 'Use by date', 'Cool, dry place');

-- fill product table with data
-- Підставте правильні category_id в залежності від вставлених категорій
...
VALUES ('anonym@example.com', 'Pokupius', 'Anonymous'),
...
VALUES (1, 100, 1.20, '2024-12-01 00:00:00', '2024-09-01 00:00:00'), -- Apple
       ...
       (4, 90, 3.00, '2024-12-10 00:00:00', '2024-09-01 00:00:00');
-- Orange
...
VALUES (5, 50, 7.00, '2024-10-05 00:00:00', '2024-09-01 00:00:00'),  -- Chicken Breast
       ...
       (8, 60, 5.50, '2024-10-15 00:00:00', '2024-09-01 00:00:00');
-- Pork Chop
...
VALUES (9, 150, 1.70, '2024-09-25 00:00:00', '2024-09-01 00:00:00'),  -- Milk
       ...
       (12, 120, 2.00, '2024-12-15 00:00:00', '2024-09-01 00:00:00');
-- Cheese
...
VALUES (13, 70, 2.00, '2024-09-20 00:00:00', '2024-09-01 00:00:00'), -- Bread
       ...
       (16, 40, 3.50, '2024-09-20 00:00:00', '2024-09-01 00:00:00');
-- Muffins
...
VALUES (17, 200, 1.00, '2025-01-01 00:00:00', '2024-09-01 00:00:00'), -- White Rice
       ...
       (20, 100, 2.50, '2025-01-01 00:00:00', '2024-09-01 00:00:00');
-- Olive Oil
...
VALUES (21, 100, 1.80, '2025-02-01 00:00:00', '2024-09-01 00:00:00'), -- Chocolate Bar
       ...
       (24, 90, 3.00, '2025-02-01 00:00:00', '2024-09-01 00:00:00');
-- Cookies
...
VALUES (25, 150, 0.80, '2025-06-01 00:00:00', '2024-09-01 00:00:00'), -- Orange Juice
       ...
       (28, 100, 1.20, '2025-06-01 00:00:00', '2024-09-01 00:00:00');
-- Green Tea
...
VALUES (29, 70, 3.50, '2025-01-01 00:00:00', '2024-09-01 00:00:00'),  -- Quinoa
       ...
       (32, 120, 2.20, '2025-01-01 00:00:00', '2024-09-01 00:00:00');
-- Gluten-Free Pasta
...
VALUES (33, 40, 5.00, '2025-03-01 00:00:00', '2024-09-01 00:00:00'),  -- Shampoo
       ...
       (36, 80, 3.00, '2025-03-01 00:00:00', '2024-09-01 00:00:00');
-- Face Cream
